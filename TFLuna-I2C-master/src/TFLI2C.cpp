...
String TFLI2C::printStatus()
{
    String val;
    // Serial.print("Status: ");
    if( tfStatus == TFL_READY)          val = "READY"; //Serial.print( "READY");
    else if( tfStatus == TFL_SERIAL)    val = "SERIAL";//Serial.print( "SERIAL");
    else if( tfStatus == TFL_HEADER)    val = "HEADER";//Serial.print( "HEADER");
    else if( tfStatus == TFL_CHECKSUM)  val = "CHECKSUM";//Serial.print( "CHECKSUM");
    else if( tfStatus == TFL_TIMEOUT)   val = "TIMEOUT";//Serial.print( "TIMEOUT");
    else if( tfStatus == TFL_PASS)      val = "PASS";//Serial.print( "PASS");
    else if( tfStatus == TFL_FAIL)      val = "FAIL";//Serial.print( "FAIL");
    else if( tfStatus == TFL_I2CREAD)   val = "I2C-READ";//Serial.print( "I2C-READ");
    else if( tfStatus == TFL_I2CWRITE)  val = "I2C-WRITE";//Serial.print( "I2C-WRITE"); 
    else if( tfStatus == TFL_I2CLENGTH) val = "I2C-LENGTH";//Serial.print( "I2C-LENGTH");
    else if( tfStatus == TFL_WEAK)      val = "Signal weak";//Serial.print( "Signal weak");
    else if( tfStatus == TFL_STRONG)    val = "Signal strong";//Serial.print( "Signal strong");
    else if( tfStatus == TFL_FLOOD)     val = "Ambient light";//Serial.print( "Ambient light");
    else if( tfStatus == TFL_INVALID)   val = "No Command";//Serial.print( "No Command");
    else val = "other"; //Serial.print( "OTHER");
    return val;
}
